...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Race race1 = new Race("Gokardy", 12);
        Race race2 = new Race("F1 Monte Carlo", 26);
        Race race3 = new Race("F1 Le Mans", 20);
        Race race4 = new Race("F1 Monte Carlo", 23);
        ...
        for (String key : raceMap.keySet()) {
            System.out.println(raceMap.get(key).getRaceYear());
        }
        Map<RaceKey, Race> raceMap2 = new HashMap<>();
        raceMap2.put(new RaceKey(race1.getRaceName(), race1.getRaceYear()), race1);
        raceMap2.put(new RaceKey(race2.getRaceName(), race2.getRaceYear()), race2);
        raceMap2.put(new RaceKey(race3.getRaceName(), race3.getRaceYear()), race3);
        raceMap2.put(new RaceKey(race4.getRaceName(), race4.getRaceYear()), race4);
        System.out.println("Mapa 2 po kluczach");
        for (RaceKey raceKey : raceMap2.keySet()) {
            System.out.println(raceMap2.get(raceKey).getRaceName() + " " + raceMap2.get(raceKey).getRaceYear());
        }
