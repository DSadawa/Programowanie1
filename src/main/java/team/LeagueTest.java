...
public class LeagueTest {
    public static void main(String[] args) {
        ...
        volleyballTeam1.setPoints(10);volleyballTeam1.setName("Skra");
        volleyballTeam2.setPoints(12);volleyballTeam2.setName("Zakra");
        volleyballTeam3.setPoints(15);volleyballTeam3.setName("Jastrzebski");
        volleyballTeam4.setPoints(8);volleyballTeam4.setName("du");
